...
int main(int argc, char **argv) {
    ...
    ros::ServiceClient dynamic_client = nh.serviceClient<dynamic_reconfigure::Reconfigure>("/move_base/TrajectoryPlannerROS/set_parameters");
    //ros::init(argc, argv, "check_robot_moving_node");
